<x-app-layout>
    ...
    {{-- ======================================================
         SLOT: HEADER HALAMAN
         Konten di dalam <x-slot name="header"> akan dirender
         di dalam komponen x-app-layout pada bagian header.
    ====================================================== --}}
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div>
                <div class="flex items-center gap-2 text-sm text-gray-400 mb-1">
                    ...
                    <span class="text-pink-500 font-semibold">Tambah Layanan Baru</span>
                </div>
    ...
    {{-- ======================================================
         ...
         Dimuat sekali di sini karena tidak semua x-app-layout
         menyertakan font kustom secara default.
    ====================================================== --}}
    @push('styles')
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if ($errors->any())
                <div class="mb-6 bg-red-50 border border-red-200 rounded-2xl p-5
                    ...
                    <div class="w-9 h-9 rounded-xl bg-red-100 flex items-center
            ...
            <form action="{{ route('admin.services.store') }}"
                ...
                {{-- ── GRID LAYOUT ────────────────────── --}}
                {{-- Kiri (2/3): field utama | Kanan (1/3): gambar + aksi --}}
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="bg-white rounded-2xl border border-pink-100 overflow-hidden
                                    shadow-sm hover:shadow-md hover:shadow-pink-50
                                    transition-shadow duration-300">

                            {{-- Card Header --}}
                            <div class="flex items-center gap-3 px-6 py-4
                                        border-b border-pink-50 bg-gradient-to-r
                                        from-white to-pink-50/40">
                                <div class="w-9 h-9 rounded-xl bg-pink-100 flex items-center
                                            justify-center shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         class="w-5 h-5 text-pink-500" fill="none"
                                         viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">
                                        Nama, deskripsi, dan harga layanan salon
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                      d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7
                                                         7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994
                                    ...
                                    <div class="flex items-start justify-between mt-1.5">
                                        <div>
                                            ...
                                            @else
                                                <p class="text-xs text-gray-400">
                                                    Tulis nama layanan yang jelas dan mudah dipahami
                                                </p>
                                            @enderror
                                        </div>
                                        <span id="titleCounter"
                                              class="text-xs text-gray-300 shrink-0 ml-3">
                                            0 / 255
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl overflow-hidden transition-all duration-200
                                        ...
                                        {{-- Prefix "Rp" --}}
                                        <span class="inline-flex items-center px-4 bg-pink-50
                                                     border-r border-pink-100 text-pink-600
                                        ...
                                        <input type="number"
                                               ...
                                               min="0"
                                               step="500"
                                               class="flex-1 px-4 py-3 text-sm text-gray-800
...
<div>
    ...
    <div class="relative">
        ...
        <select id="category"
            ...
            {{-- ★ value harus persis 'service' dan 'product' (huruf kecil) ★ --}}
            <option value="service"
                    {{ old('category') === 'service' ? 'selected' : '' }}>
                ✂️ Katalog Layanan Jasa Salon
            </option>

            <option value="product"
                    {{ old('category') === 'product' ? 'selected' : '' }}>
    ...
    @enderror
                                ...
                                <div>
                                    ...
                                    <textarea id="description"
                                              name="description"
                                              rows="6"
                                              placeholder="Jelaskan detail layanan ini: manfaat, proses perawatan, berapa lama, produk yang digunakan, hal-hal yang perlu diketahui pelanggan sebelum datang..."
                                              class="w-full px-4 py-3 text-sm text-gray-800
                                                     ...
                                                     @else
                                                         border-pink-100 hover:border-pink-200
                                                     @enderror"
                                              style="min-height: 140px;">{{ old('description') }}</textarea>
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="bg-white rounded-2xl border border-pink-100 overflow-hidden
                            ...
                            <div class="p-5 space-y-4">
                                ...
                                {{-- ── DROPZONE (hilang setelah foto dipilih) --}}
                                <label id="dropzone"
                                       for="image"
                                    ...
                                    {{-- Icon Upload --}}
                                    <div class="w-12 h-12 rounded-2xl bg-white border border-pink-200
                                                flex items-center justify-center shadow-sm
                                                group-hover:shadow-md group-hover:border-pink-300
                                                transition-all duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             class="w-6 h-6 text-pink-400 group-hover:text-pink-500
                                ...
                                {{-- Tips Foto --}}
                                <div class="flex gap-2.5 bg-amber-50 border border-amber-100
                                            rounded-xl p-3.5">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4
                                                 ...
                                                 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988
                                                 -2.386l-.548-.547z"/>
                                    </svg>
                                    <p class="text-xs text-amber-700 leading-relaxed">
                                        <strong class="font-semibold">Tips:</strong> Foto yang terang dan
                                        menampilkan hasil nyata meningkatkan minat pelanggan secara signifikan.
                                    </p>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl border border-pink-100 shadow-sm overflow-visible">
                            ...
                            <div class="p-5 space-y-3 h-auto">

                                {{-- Status publish --}}
                                <div class="flex items-center gap-3 p-3.5 bg-green-50
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-green-600 font-light">
                                            Layanan tampil di website setelah disimpan
                                        </p>
                                    </div>
                                </div>
...
<button type="submit"
        id="submitBtn"
        class="w-full block inline-flex items-center justify-center gap-2.5
    ...
    <span id="submitLabel">Simpan Layanan</span>
</button>
                        ...
                        {{-- ┌─────────────────────────────┐
                             │  CARD 4: Checklist          │
                             └─────────────────────────────┘ --}}
                        <div class="bg-white rounded-2xl border border-pink-100
    ...
    (function () {
        ...
        /* Drag & Drop */
        const dropLabel = dropzone;
        dropLabel.addEventListener('dragover',  (e) => {
            e.preventDefault();
            dropLabel.classList.add('border-pink-500', 'bg-pink-100');
        });
        dropLabel.addEventListener('dragleave', () => {
            dropLabel.classList.remove('border-pink-500', 'bg-pink-100');
        });
        dropLabel.addEventListener('drop', (e) => {
            ...
            if (file) {
                /* Assign ke input lewat DataTransfer */
        ...
        document.getElementById('createServiceForm')
        ...
        /* ── 7. Inisiasi Awal (isi ulang state dari old() jika validasi gagal) ── */
        (function init() {
            if (titleInput.value) {
